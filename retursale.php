...
<body>
<form method="post" action="addretursale.php">
    <div class="container">
...
<div class="container" style="padding-top:50px">
        ...
        <?php
            ...
            if ($result->num_rows > 0)  
            {
                while($row = $result->fetch_assoc()) 
                {
                    ...
                    printf('<td><a href="deleteretursale.php?sretur_id=%s"><b>DELETE</b></a></td>',$pr_id,$pr_id);
                    print("</tr>");
                }
            }
        ?>
    ...
    <button type="submit" class="btn btn-primary"><a href="printretur.php" style="color: white; text-decoration: none"> Print</a></button>
</div>
